-- Phase 1: GREEN-only guardrails + view + index
-- Enforce structured specs for GREEN chargers, provide GREEN-only view for clean queries
-- Non-charger parts remain unaffected
...
-- 2) Trigger to enforce GREEN data quality (others remain NULL-allowed)
...
-- 3) GREEN-only view for clean selector queries
...
-- 4) Helper function to validate GREEN data before bulk operations
