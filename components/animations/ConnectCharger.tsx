...
export default function ConnectCharger({ className }: { className?: string }) {
  ...
  React.useEffect(() => {
    ...
    async function load() {
      const res = await fetch("/training/animations/d4-connect-charger.svg", { cache: "force-cache" });
  ...
  return (
    <div
      className={className}
      aria-label="Connect charger animation"
      role="img"
