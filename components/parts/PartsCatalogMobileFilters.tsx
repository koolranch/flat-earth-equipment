...
import { buildCatalogUrl, type CatalogSearchParams } from '@/lib/parts/catalogQuery';
...
export default function PartsCatalogMobileFilters({ searchParams, labels }: Props) {
  const pills = [
    { label: labels.allParts, href: '/parts', active: !searchParams.sales_type && !searchParams.in_stock },
    {
    ...
    },
    {
      ...
      href: buildCatalogUrl(searchParams, { sales_type: 'quote_only', in_stock: undefined }),
