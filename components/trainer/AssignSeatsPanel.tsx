  ...
  return (
    <section className="space-y-3">
      <div className="flex items-center gap-3">
        <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-orange-50 text-[#F76511]">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
        </span>
        <div>
          <h2 className="text-lg font-semibold text-slate-900">Assign Seats</h2>
          <p className="text-xs text-slate-500">Invite operators by email — each gets a training seat.</p>
        </div>
      </div>
      <div className="grid sm:grid-cols-3 gap-3">
        <label className="text-sm">Course
          <select 
            ...
            className="block w-full rounded-lg border border-slate-300 px-3 py-2 mt-1 bg-white text-sm focus:border-[#F76511] focus:outline-none focus:ring-2 focus:ring-[#F76511]/20"
          >
        ...
        <label className="text-sm sm:col-span-2">
          ...
          <textarea 
            ...
            rows={6} 
            className="block w-full rounded-lg border border-slate-300 px-3 py-2 font-mono text-sm bg-white focus:border-[#F76511] focus:outline-none focus:ring-2 focus:ring-[#F76511]/20" 
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <label className="text-sm">Note (optional)
          <input 
            ...
            className="block w-full rounded-lg border border-slate-300 px-3 py-2 mt-1 text-sm focus:border-[#F76511] focus:outline-none focus:ring-2 focus:ring-[#F76511]/20"
          />
        </label>
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="rounded-lg bg-[#F76511] text-white px-5 py-2.5 text-sm font-semibold shadow-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#E55A0C] transition-colors"
        >
          {loading ? (
            ...
            <span>{sendEmails ? 'Create & Send Invites' : 'Create Invites Only'}</span>
          )}
        </button>
      </div>
