...
export function AdminTeamRoster({ orgId }: AdminTeamRosterProps) {
  ...
  const loadMembers = useCallback(async () => {
    ...
    try {
      const params = new URLSearchParams({
        page: page.toString(),
        pageSize: '50', // Larger page size for admin view
      });
  ...
  const inProgressCount = members.filter(m => m.status === 'active').length;
    ...
    <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">
                  Team members who completed online training and need hands-on evaluation
                </p>
              </div>
            </div>
            <EnterpriseButton
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-blue-800">
                  Showing {members.length} member{members.length !== 1 ? 's' : ''} needing practical evaluation
                </p>
      ...
      <EnterpriseCard>
        <div className="flex items-center justify-between mb-4">
          <div>
            <EnterpriseH2>All Team Members</EnterpriseH2>
            <p className="text-sm text-gray-500 mt-1">
              {completedCount} completed • {inProgressCount} in progress • {total} total
            </p>
          </div>
...
export default AdminTeamRoster;
