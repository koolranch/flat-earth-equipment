...
const baseConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/safety-training', destination: '/safety', permanent: true },
      { source: '/safety-training/:path*', destination: '/safety', permanent: true },
      { source: '/forklift-safety', destination: '/safety', permanent: true },
      { source: '/forklift-safety/:path*', destination: '/safety', permanent: true },
      { source: '/operator-training', destination: '/safety', permanent: true },
      { source: '/operator-training/:path*', destination: '/safety', permanent: true },
      { source: '/certification', destination: '/safety', permanent: true },
      { source: '/certification/:path*', destination: '/safety', permanent: true },
      { source: '/osha-training', destination: '/safety', permanent: true },
      { source: '/osha-certification', destination: '/safety', permanent: true },
      { source: '/forklift-certification', destination: '/safety', permanent: true },
      { source: '/forklift-license', destination: '/safety', permanent: true },
      { source: '/blog/forklift-safety', destination: '/safety', permanent: true },
      { source: '/blog/forklift-safety/:path*', destination: '/safety', permanent: true },
      { source: '/blog/osha-requirements', destination: '/safety', permanent: true },
      { source: '/blog/osha-requirements/:path*', destination: '/safety', permanent: true },
      { source: '/blog/operator-certification', destination: '/safety', permanent: true },
      { source: '/safety/training', destination: '/safety', permanent: true },
      { source: '/safety/certification', destination: '/safety', permanent: true },
      ...
      // Quote-intent aliases → /quote (do NOT redirect /quote itself — it is a live form)
