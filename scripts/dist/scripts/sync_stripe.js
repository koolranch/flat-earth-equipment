...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, parts, error, _i, parts_1, part, product, price, updErr;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (updErr) {
                        console.error("Failed to update part ".concat(part.id, ":"), updErr);
                    }
                    else {
                        console.log("\u2705 Synced ".concat(part.slug, " \u2192 ").concat(price.id));
                    }
                    _b.label = 6;
                case 6:
                    _i++;
