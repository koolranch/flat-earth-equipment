...
function testCheckout() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, product, productError, response, data, error_1;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 1:
                    _a = _b.sent(), product = _a.data, productError = _a.error;
                    if (productError) {
                    ...
                    return [4 /*yield*/, fetch('http://localhost:3000/api/checkout', {
                            method: 'POST',
