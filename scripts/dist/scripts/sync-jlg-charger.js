...
function syncJlgCharger() {
    return __awaiter(this, void 0, void 0, function () {
        var stripe, supabase, _a, part, fetchErr, productId, stripeProduct, stripePrice, updateErr;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 1:
                    _a = _b.sent(), part = _a.data, fetchErr = _a.error;
                    if (fetchErr)
                        throw fetchErr;
                    if (!part)
                        throw new Error('JLG charger not found');
                    productId = part.stripe_product_id;
                ...
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4: return [4 /*yield*/, stripe.prices.create({
                        product: productId,
