...
function archiveDuplicateShippingRates() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stripe.shippingRates.update('shr_1RZdGvHJI548rO8Jt0aY9ZIa', {
                            active: false
                        })];
                case 1:
                    // Archive duplicate free shipping rate
                    ...
                    return [4 /*yield*/, stripe.shippingRates.update('shr_1RZdinHJI548rO8JYgwzuQuP', {
                            active: false
                        })];
                case 2:
                    // Archive duplicate standard shipping rate
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('❌ Error archiving shipping rates:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 4];
