...
function backfillStripeData() {
    return __awaiter(this, void 0, void 0, function () {
        var stripe, supabase, _a, parts, fetchError, _i, parts_1, part, stripeProduct, updateProdErr, unit_amount, stripePrice, updatePriceErr;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _a = _c.sent(), parts = _a.data, fetchError = _a.error;
                    if (fetchError)
                        throw fetchError;
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .eq('id', part.id)];
                case 4:
                    updateProdErr = (_c.sent()).error;
                    if (updateProdErr)
                        throw updateProdErr;
                    unit_amount = (_b = part.price_cents) !== null && _b !== void 0 ? _b : Math.round(Number(part.price) * 100);
                ...
                case 5:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .eq('id', part.id)];
                case 6:
                    updatePriceErr = (_c.sent()).error;
                    if (updatePriceErr)
                        throw updatePriceErr;
                    console.log("\u2705 Synced part ".concat(part.name, ": product ").concat(stripeProduct.id, ", price ").concat(stripePrice.id));
                    _c.label = 7;
                case 7:
                    _i++;
                    return [3 /*break*/, 2];
