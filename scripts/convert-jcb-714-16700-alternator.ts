/**
 * Convert JCB 714/16700 quote stub → Buy Now. Keep sku/slug 71416700.
 *
 * Magnasource: $658.71 in stock (2 on hand, 2026-09-16)
 * Sell: ~5% under Mag (assembly rounding)
 *
 * Run: npx tsx scripts/convert-jcb-714-16700-alternator.ts
 */
...
const SKU = '71416700';
const COMP_PRICE = 658.71;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC714/16700';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-714-16700-alternator.jpg'
);
const STORAGE_PATH = 'jcb-714-16700-alternator.jpg';

const NAME = 'JCB 714/16700 Alternator';
const DESCRIPTION = [
  'Aftermarket alternator for JCB equipment. Replaces OEM part number 714/16700.',
  'Cast aluminum housing with a multi-blade cooling fan, a black dual-groove pulley, a hex nut on the shaft, a rear mounting flange, and rear electrical studs.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 714/16700 alternator. Cooling fan, dual-groove pulley, rear flange and electrical studs.'.slice(
          0,
          500
        ),
      images: [imageUrl],
