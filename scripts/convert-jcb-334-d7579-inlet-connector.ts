/**
 * Convert JCB 334/D7579 quote stub → Buy Now. Keep sku/slug 334D7579.
 *
 * Cost $150 (operator). Mag sticker $219.42 / 16 on hand (2026-09-19).
 * Sell $208 (~5% under Mag).
 *
 * Run: npx tsx scripts/convert-jcb-334-d7579-inlet-connector.ts
 */
...
const OEM = '334/D7579';
const COST = 150;
const COMP_PRICE = 219.42;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC334/D7579';
const WEIGHT_LB = 0.04;
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-334-d7579-sm65-inlet-connector-kit.jpg'
);
const STORAGE_PATH = 'jcb-334-d7579-sm65-inlet-connector-kit.jpg';

const NAME = 'JCB 334/D7579 SM 6-5 Inlet Connector Kit';
const DESCRIPTION = [
  'Aftermarket SM 6-5 inlet connector kit for JCB equipment. Replaces OEM part number 334/D7579.',
  'Kit includes the black hose connector, green dust cap, and U-clip. This is the inlet connector set, not a complete fuel line. About 0.04 lb.',
  ...
  const { error: updErr } = await supabase
    ...
    .update({
      ...
      metadata: {
        ...
        product_type: 'inlet_connector_kit',
        cost_wholesale: COST,
        freight_cents: 3100,
        weight_lbs: WEIGHT_LB,
        secondary_category: 'SM 6-5 Inlet Connector Kit',
        mag_watch: {
          ...prevWatch,
          hero: {
