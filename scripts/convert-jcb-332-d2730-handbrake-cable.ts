/**
 * Convert JCB 332/D2730 quote stub → Buy Now. Keep sku/slug 332D2730.
 *
 * Magnasource: $140.37 in stock (100+ on hand, 2026-09-16)
 * Sell: ~5% under Mag
 * Freight: $24 Ground via metadata.freight_cents (JCB under-$150 band)
 *
 * Run: npx tsx scripts/convert-jcb-332-d2730-handbrake-cable.ts
 */
...
const SKU = '332D2730';
const COMP_PRICE = 140.37;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC332/D2730';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-332-d2730-handbrake-cable.jpg'
);
const STORAGE_PATH = 'jcb-332-d2730-handbrake-cable.jpg';

const NAME = 'JCB 332/D2730 Handbrake Cable';
const DESCRIPTION = [
  'Aftermarket handbrake cable for JCB equipment. Replaces OEM part number 332/D2730.',
  'Clevis fork and ribbed boot on one end, a threaded barrel fitting on the other. Long cable.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 332/D2730 handbrake cable. Clevis and ribbed boot, threaded barrel end.'.slice(
          0,
          500
        ),
      images: [imageUrl],
