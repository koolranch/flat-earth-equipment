/**
 * Phase 2 - Batch 14: Sync pricing for the next 10 JCB parts.
 * 
 * Run with: npx tsx scripts/sync-jcb-batch-14.ts
 */
...
const batchPrices: { sku: string; compPrice: number | null }[] = [
  { sku: "25929305", compPrice: 12.22 },
  { sku: "25937100", compPrice: 79.61 },
  // 25957201 => N/A (remove) - handled separately
  { sku: "25MM5000", compPrice: 229.18 },
  { sku: "25MM6396", compPrice: 270.60 },
  { sku: "26500678", compPrice: 16.93 },
  // 27400859 => N/A (remove) - handled separately
  { sku: "29000701", compPrice: 33.79 },
  { sku: "29500076", compPrice: 327.09 },
  { sku: "30925759", compPrice: 21.65 }
];

async function syncBatch() {
  console.log('🚀 Starting JCB Batch 14 Pricing Sync...\n');
  ...
  console.log('🏁 Batch 14 Pricing Sync Complete.');
