/**
 * Convert JCB 452/02600 quote stub → Buy Now. Keep sku/slug 45202600.
 *
 * Magnasource: $381.52 in stock (12 on hand, 2026-09-16)
 * Sell: ~5% under Mag (assembly rounding)
 *
 * Run: npx tsx scripts/convert-jcb-452-02600-hand-brake-lever.ts
 */
...
const SKU = '45202600';
const COMP_PRICE = 381.52;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC452/02600';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-452-02600-hand-brake-lever.jpg'
);
const STORAGE_PATH = 'jcb-452-02600-hand-brake-lever.jpg';

const NAME = 'JCB 452/02600 Hand Brake Lever';
const DESCRIPTION = [
  'Aftermarket hand brake lever for JCB equipment. Replaces OEM part number 452/02600.',
  'Black grip on a zinc mounting plate with a cable roller and spacer bushings.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 452/02600 hand brake lever. Black grip, zinc plate, cable roller, spacer bushings.'.slice(
          0,
          500
        ),
      images: [imageUrl],
