#!/usr/bin/env python3
"""
Pause Navitas Kits Shopping (24170389196) — 2026-09-05.

Aug 23–Sep 5: 123 clicks, $145.83, zero Ads conversions, and zero Stripe
checkout starts on any Navitas SKU. Same failure mode as the Sep 2 lithium
campaign pause. TAC3 Item IDs were still under the ~$312 max-CPA kill line
but click-to-cart is dead (brand queries included).
...
Run with the MCP server venv python:
  /Users/christopherray/.mcp-servers/mcp-google-ads/.venv/bin/python \
    scripts/ads/2026-09-05-navitas-pause-campaign.py [--apply]
"""
...
def main():
    headers = get_headers()
    print("  Navitas Kits Shopping 24170389196 -> PAUSED")
    url = (
    ...
    if resp.status_code != 200:
        ...
        sys.exit(1)
    print(f"[{mode}] Navitas campaign pause: OK")
