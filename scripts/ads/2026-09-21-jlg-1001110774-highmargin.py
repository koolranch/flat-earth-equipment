#!/usr/bin/env python3
"""
Add JLG 1001110774 mould-on wheel to High-Margin Parts Shopping (24175332700).

New ad group + Item ID listing tree (everything-else negated). CPC $1.00 under
~$332 unit profit ($719 sell − $387.26 cost; $192 LTL is a Mag-matched pass-through).
Kill line: ~$166 spend (50% of unit profit) with no sale.

Does not change campaign budget, geo, network, or conversion goals.
Merchant XML must include g:id 1001110774 (keep-set slug jlg-1001110774-drive-wheel)
and be committed + deployed before ads can serve.

Run:
  /Users/christopherray/.mcp-servers/mcp-google-ads/.venv/bin/python \
    scripts/ads/2026-09-21-jlg-1001110774-highmargin.py [--apply]
"""
...
AG_NAME = "JLG 1001110774 mould-on wheel"
