/**
 * Convert JCB 332/C8166 quote stub → Buy Now. Keep sku/slug 332C8166.
 *
 * Magnasource: $247.74 in stock (100+ on hand, 2026-09-16)
 * Sell: ~5% under Mag
 * Freight: $29 Ground via metadata.freight_cents (JCB $150–$299 band)
 *
 * Run: npx tsx scripts/convert-jcb-332-c8166-proximity-switch.ts
 */
...
const SKU = '332C8166';
const COMP_PRICE = 247.74;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC332/C8166';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-332-c8166-proximity-switch.jpg'
);
const STORAGE_PATH = 'jcb-332-c8166-proximity-switch.jpg';

const NAME = 'JCB 332/C8166 Proximity Switch';
const DESCRIPTION = [
  'Aftermarket proximity switch for JCB equipment. Replaces OEM part number 332/C8166.',
  'Blue rectangular sensor head, black corrugated loom, 2-pin connector, and a ring-terminal tab.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 332/C8166 proximity switch. Blue sensor head, corrugated loom, 2-pin connector.'.slice(
          0,
          500
        ),
      images: [imageUrl],
