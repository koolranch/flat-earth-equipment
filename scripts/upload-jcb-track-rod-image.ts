/**
 * Upload JCB Track Rod image to Supabase Storage and update parts record
 */
...
const SKU = '45321300';
const IMAGE_FILENAME = 'jcb-453-21300-track-rod-assembly.png';
const LOCAL_IMAGE_PATH = path.join(process.cwd(), 'public', 'images', 'products', IMAGE_FILENAME);
const BUCKET_NAME = 'products';

async function uploadImage() {
  console.log('🖼️  JCB Track Rod Image Upload Script\n');
