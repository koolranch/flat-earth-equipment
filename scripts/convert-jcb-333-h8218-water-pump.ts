/**
 * Convert JCB 333/H8218 quote stub → Buy Now. Keep sku/slug 333H8218.
 *
 * Magnasource: $945.79 in stock (28 on hand, 2026-09-16)
 * Sell: ~5% under Mag (assembly rounding)
 *
 * Run: npx tsx scripts/convert-jcb-333-h8218-water-pump.ts
 */
...
const SKU = '333H8218';
const COMP_PRICE = 945.79;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC333/H8218';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-333-h8218-water-pump.jpg'
);
const STORAGE_PATH = 'jcb-333-h8218-water-pump.jpg';

const NAME = 'JCB 333/H8218 Water Pump Assembly';
const DESCRIPTION = [
  'Aftermarket water pump assembly for JCB equipment. Replaces OEM part number 333/H8218.',
  'Black cast housing with a multi-groove pulley, a side coolant outlet, and three mounting holes around the body.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 333/H8218 water pump assembly. Multi-groove pulley, side outlet, three-hole mount.'.slice(
          0,
          500
        ),
      images: [imageUrl],
