/**
 * Phase 2 - Batch 13: Sync pricing for the next 10 JCB parts.
 * 
 * Run with: npx tsx scripts/sync-jcb-batch-13.ts
 */
...
const batchPrices: { sku: string; compPrice: number | null }[] = [
  { sku: "25207300", compPrice: 350.45 },
  // 25220595 => N/A (remove) - handled separately
  { sku: "25220998", compPrice: 188.60 },
  { sku: "25221263", compPrice: 132.42 },
  // 25222619 => N/A (remove) - handled separately
  { sku: "25222645", compPrice: 76.46 },
  { sku: "25223168", compPrice: 130.42 },
  { sku: "25223170", compPrice: 156.28 },
  { sku: "25527003", compPrice: 89.52 },
  { sku: "25926908", compPrice: 44.90 }
];

async function syncBatch() {
  console.log('🚀 Starting JCB Batch 13 Pricing Sync...\n');
  ...
  console.log('🏁 Batch 13 Pricing Sync Complete.');
