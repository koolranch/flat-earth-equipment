/**
 * Phase 2 - Batch 21: Sync pricing for the next 10 JCB parts.
 * 
 * Run with: npx tsx scripts/sync-jcb-batch-21.ts
 */
...
const batchPrices: { sku: string; compPrice: number | null }[] = [
  { sku: "320E9551",  compPrice: 502.39 },
  { sku: "320E9653",  compPrice: 341.75 },
  { sku: "32206002",  compPrice: 94.98 },
  { sku: "32903201",  compPrice: 137.78 },
  { sku: "32903202",  compPrice: 102.56 },
  { sku: "32906501",  compPrice: 238.71 },
  { sku: "32-906503", compPrice: 294.73 },
  { sku: "32906503",  compPrice: 294.73 },
  { sku: "32908400",  compPrice: 89.83 },
  { sku: "32911801",  compPrice: 119.56 }
];

async function syncBatch() {
  console.log('🚀 Starting JCB Batch 21 Pricing Sync...\n');
  ...
  console.log('🏁 Batch 21 Pricing Sync Complete.');
