/**
 * Convert Genie 137634GT quote stub → Buy Now.
 * Keep sku 137634GT / slug genie-137634gt-joystick.
 *
 * Magnasource: $311.84 in stock (100+ on hand, 2026-09-16)
 * Sell: ~5% under Mag (assembly rounding)
 * Freight: $31 Ground via metadata.freight_cents (TVH $150–$299 band)
 *
 * Run: npx tsx scripts/convert-genie-137634gt-joystick.ts
 */
...
const SKU = '137634GT';
const COMP_PRICE = 311.84;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/GN137634GT';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/genie-137634gt-joystick.jpg'
);
const STORAGE_PATH = 'genie-137634gt-joystick.jpg';

const NAME = 'Genie 137634GT Joystick Controller';
const DESCRIPTION = [
  'Aftermarket joystick controller for Genie aerial equipment. Replaces OEM part number 137634GT.',
  'Square silver mounting plate, black cylindrical handle on a ribbed bellows, a 4-wire pigtail, and a black 4-pin connector. No extra buttons on the grip.',
  'In stock.',
].join('\n\n');
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket Genie 137634GT joystick. Square plate, cylindrical handle, 4-pin pigtail.'.slice(
          0,
          500
        ),
      images: [imageUrl],
