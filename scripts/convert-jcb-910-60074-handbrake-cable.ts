/**
 * Convert JCB 910/60074 quote stub → Buy Now. Keep sku/slug 91060074.
 *
 * Magnasource: $239.65 limited (4 on hand, 2026-09-16)
 * Sell: ~5% under Mag
 *
 * Run: npx tsx scripts/convert-jcb-910-60074-handbrake-cable.ts
 */
...
const SKU = '91060074';
const COMP_PRICE = 239.65;
const COMP_URL = 'https://www.magnasourceinc.com/itemdetail/JC910/60074';
...
const LOCAL_IMAGE = path.resolve(
  process.cwd(),
  'public/images/parts/jcb-910-60074-handbrake-cable.jpg'
);
const STORAGE_PATH = 'jcb-910-60074-handbrake-cable.jpg';

const NAME = 'JCB 910/60074 Handbrake Cable';
const DESCRIPTION = [
  'Aftermarket handbrake cable for JCB equipment. Replaces OEM part number 910/60074.',
  'Black sheathed cable with a clevis fork on each end, a ribbed boot, and a coil-spring adjuster.',
...
async function main() {
  ...
  if (!stripeProductId) {
    const product = await stripe.products.create({
      name: NAME,
      description:
        'Aftermarket JCB 910/60074 handbrake cable. Dual clevis forks, ribbed boot, coil-spring adjuster.'.slice(
          0,
          500
        ),
      images: [imageUrl],
