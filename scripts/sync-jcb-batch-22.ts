/**
 * Phase 2 - Batch 22: Sync pricing for the next 10 JCB parts.
 * 
 * Run with: npx tsx scripts/sync-jcb-batch-22.ts
 */
...
const batchPrices: { sku: string; compPrice: number | null }[] = [
  { sku: "32911802",  compPrice: 91.38 },
  { sku: "32-915801", compPrice: 20.98 },
  { sku: "32-915802", compPrice: 74.02 },
  { sku: "32-917804", compPrice: 138.45 },
  { sku: "32-925346", compPrice: 70.10 },
  { sku: "32925421",  compPrice: 101.45 },
  { sku: "32-925683", compPrice: 70.24 },
  { sku: "32925683",  compPrice: 70.24 },
  { sku: "32925694",  compPrice: 68.94 },
  { sku: "32925708",  compPrice: 79.16 }
];

async function syncBatch() {
  console.log('🚀 Starting JCB Batch 22 Pricing Sync...\n');
  ...
  console.log('🏁 Batch 22 Pricing Sync Complete.');
