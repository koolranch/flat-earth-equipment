...
export default function FaqSchema() {
  const data = {
    ...
    'mainEntity': [
      ...
      { '@type': 'Question', 'name': 'How fast can I get my certificate?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Most operators finish in under 30 minutes. The certificate is available for instant download upon passing the exam.' } },
