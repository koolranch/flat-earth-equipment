    ...
    <main>
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-6 text-center">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold leading-tight text-white mb-4">
              Forklift & Industrial Equipment Parts in Pueblo, CO
            </h1>
            <p className="text-white text-lg mb-6">
              Same-day quotes. Fast shipping across southern Colorado and the Front Range.
            </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <p className="text-lg text-slate-700 mb-8">
          Flat Earth Equipment proudly serves Pueblo and the southern Colorado Front Range with precision-fit parts, dispatch-ready rentals, and expert support. We deliver to industrial facilities, contractors, and municipalities throughout Pueblo County, the I-25 corridor, and surrounding areas. Our Western-focused approach ensures you get rugged, reliable parts without the overhead costs of traditional local distributors.
        </p>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-slate-800 mb-6">Popular Parts in Pueblo</h2>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <p className="text-lg text-slate-700">
              We provide fast delivery throughout Pueblo and southern Colorado, including the I-25 industrial corridor, Pueblo West, and surrounding communities. Whether you're operating in downtown Pueblo warehouses or outlying industrial parks, we ensure prompt delivery of your equipment parts.
            </p>
          </div>
        </section>
        ...
        <nav className="text-sm mb-6">
          <ol className="flex items-center space-x-2">
            ...
            <li className="text-gray-400">/</li>
            <li className="text-gray-900">Pueblo, CO</li>
          </ol>
        </nav>

        <h1 className="text-3xl font-bold mb-6">Pueblo, CO</h1>
        <p className="text-lg text-slate-700 mb-6">
          Flat Earth Equipment proudly serves Pueblo and the southern Colorado Front Range with precision-fit parts, dispatch-ready rentals, and expert support. Fast delivery from our Western hubs without local storefront overhead.
        </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Our Pueblo service area covers southern Colorado, providing industrial parts and equipment rentals to contractors and facilities throughout the region.
              </p>
            </div>
          </div>
        </div>
