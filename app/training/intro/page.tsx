...
export default function IntroPage({ searchParams }: { searchParams?: Record<string, string | string[] | undefined> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl py-10">
      ...
      <div className="mt-6">
        <Link href="/training/modules/pre-op" className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Start Module 1</Link>
      </div>
    </div>
  );
}
