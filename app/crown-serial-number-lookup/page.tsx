...
const EQUIPMENT_TYPES = [
  "Counterbalance (IC) (C-5)",
  "Counterbalance (4-Wheel Electric) (FC)",
  "Stand-Up Counterbalance (RC)",
  "Reach Truck (RR/RD)",
  "Order Picker (SP)",
  "Walkie Pallet (WP)",
  "Walkie Stacker (ST/SX)",
  "Any"
];

export default function CrownLookupPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/crown-lookup", {
        method: "POST",
  ...
  return (
    <>
      <Script 
        id="crown-lookup-structured-data"
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900">
            Crown Forklift Serial Number Lookup
          </h1>
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            Enter your Crown serial/PIN and choose a truck type. We'll show data-plate locations by family, 
            infer the family from model prefixes (FC/SC/RC/RR/RD/RM/SP/ST/SX/WP, etc.), and decode the 
            model year only when a true 17-character VIN/PIN is detected.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-6 bg-white rounded-2xl p-6 shadow-lg border">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input 
                className="w-full rounded-xl border border-gray-300 px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                placeholder="e.g., FC5200 A123456, or 17-char VIN/PIN" 
                value={serial} 
                onChange={(e) => setSerial(e.target.value)} 
                required 
              />
              <p className="mt-2 text-xs text-slate-500">
                Tip: Counterbalance plates are often on the overhead guard; RR/RC/SP show plates on a console in the operator area.
              </p>
            </div>
          </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="rounded-xl bg-white p-4 border border-gray-200">
                      <div className="text-sm text-slate-500 mb-1">Inferred family prefix</div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                      ...
                      <div className="text-sm text-slate-600">Fast pricing on Crown parts</div>
                    </a>
                    ...
                    >
                      ...
                      <div className="font-medium text-gray-900 group-hover:text-orange-600">Crown Parts</div>
                    ...
                    >
                      ...
                      <div className="font-medium text-gray-900 group-hover:text-yellow-600">Crown Battery Chargers</div>
