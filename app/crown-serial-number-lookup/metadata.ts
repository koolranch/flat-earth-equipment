...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "/crown-serial-number-lookup",
    type: "website",
    images: [
      {
        url: "/images/crown-serial-lookup-og.jpg",
        width: 1200,
        height: 630,
        alt: "Crown Forklift Serial Number Lookup Tool"
      }
    ]
  },
  twitter: {
    ...
    title: "Crown Forklift Serial Number Lookup",
    description: "Find Crown data plate locations and decode VIN/PIN for model year identification.",
    images: ["/images/crown-serial-lookup-og.jpg"]
  }
};
