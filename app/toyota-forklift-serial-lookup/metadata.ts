...
export const metadata: Metadata = {
  ...
  keywords: "toyota forklift serial number lookup, toyota forklift year by serial number, toyota forklift model year, forklift serial number decoder, toyota forklift parts lookup",
  openGraph: {
  ...
  alternates: {
    canonical: "/toyota-forklift-serial-lookup",
  },
};
