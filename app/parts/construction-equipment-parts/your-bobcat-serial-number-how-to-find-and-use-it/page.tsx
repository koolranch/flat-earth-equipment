...
export const metadata: Metadata = {
  ...
  description: "Learn how to find and use your Bobcat serial number for parts ordering, maintenance, and equipment identification. Expert guide with detailed instructions.",
  alternates: {
    canonical: "/parts/construction-equipment-parts/your-bobcat-serial-number-how-to-find-and-use-it",
  },
};
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <h2>Serial Number Chart for Bobcat Equipment</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              <tr>
                <td className="border p-2">R-Series</td>
                <td className="border p-2">Right upper-rear, above tailgate</td>
              </tr>
              <tr>
                <td className="border p-2">M-Series</td>
                <td className="border p-2">Right of the main frame, under cooling compartment</td>
              </tr>
              <tr>
                <td className="border p-2">K-Series</td>
                <td className="border p-2">Rear frame upright (right or left)</td>
              </tr>
              <tr>
                <td className="border p-2">Older Models</td>
                <td className="border p-2">Varies on rear upright (inside/outside)</td>
              </tr>
              <tr>
                <td className="border p-2">Articulated</td>
                <td className="border p-2">Lower frame (entry side)</td>
              </tr>
            </tbody>
          </table>
        </div>
