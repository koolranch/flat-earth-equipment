...
export default function Page() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/linde-lookup", {
        method: "POST", 
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-2 text-slate-600">
        Enter your serial/PIN and optional model (e.g., E20/E35, X25, H35/H50, R16, L14, V10). 
        We'll show plate locations and any serial-related notes.
      </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2">
            ...
            <input 
              ...
              placeholder="e.g., E20 386-xxxxx • H35 1202-xxxxx • R16 1120-xxxxx" 
              value={serial} 
          ...
          <div className="md:col-span-2">
            ...
            <input 
              className="w-full rounded-xl border px-3 py-2" 
              placeholder="E16–E20 • E18–E20 • E25–E35 • E35–E50 • X20–X35 • H20–H35 • H35–H50 • R14–R20 • L14–L20 • V10" 
              value={model} 
              onChange={(e) => setModel(e.target.value)} 
            />
            <p className="mt-1 text-xs text-slate-500">
              Tip: The data plate is usually near the mast, counterweight, or operator area; record the serial exactly.
            </p>
          </div>
        </div>
        <button 
          ...
          {"error" in data && data.error ? (
            ...
            <>
              ...
              <div className="mt-5">
                ...
                <ul className="list-disc pl-6 mt-2 text-slate-700">
                  {data.plate?.guidance?.length ? data.plate.guidance.map((t, i) => (
                    ...
                    <li>Use the truck data/identification plate on the body/frame; record the full serial.</li>
                  )}
                </ul>
              </div>
              ...
              <div className="mt-8 p-4 bg-white rounded-xl border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                  ...
                  >
                    ...
                    <div className="text-slate-600">OSHA forklift certification and material handling training</div>
                  </a>
                  <a 
                    href="/quote" 
                    className="block p-3 border rounded-lg hover:border-blue-300 transition-colors"
                  >
                    ...
                    <div className="text-slate-600">Get pricing for Linde parts and components</div>
                  </a>
                  <a 
                    href="/parts" 
                    className="block p-3 border rounded-lg hover:border-blue-300 transition-colors"
                  >
                    <div className="font-medium mb-1">Linde Parts</div>
                    <div className="text-slate-600">Browse forklift and material handling equipment parts</div>
                  </a>
                  <a 
                  ...
                  >
                    ...
                    <div className="text-slate-600">Chargers for electric forklifts and material handling equipment</div>
                  </a>
                </div>
              </div>
              ...
              <section className="mt-8 text-sm text-slate-600">
                ...
                <a className="underline hover:text-blue-600" href="/ep-forklift-serial-number-lookup">EP</a>
              </section>
            </>
          )}
        </div>
