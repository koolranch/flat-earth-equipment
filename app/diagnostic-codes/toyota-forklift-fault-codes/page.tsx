  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-lg text-slate-600 mb-8">
        Searchable database of 40+ Toyota forklift diagnostic codes. Find codes for electric (7-series, 8-series) and IC (4Y-ECS) models with detailed troubleshooting steps.
      </p>
      ...
      {/* Keep the rest - General Troubleshooting, Parts CTA, Related Resources, Disclaimer */}
      <div className="prose prose-slate max-w-none mb-8 mt-12">
