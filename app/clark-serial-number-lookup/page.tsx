...
const EQUIPMENT_TYPES = [
  "Electric Sit-Down",
  "IC Counterbalance (Cushion/Pneumatic)",
  "Reach (SRX)",
  "Order Picker (OSX/OPX)",
  "Pallet (WP/WT/PC/PE)",
  "Stacker (ST/SX/WSX)",
  "Any"
];

export default function ClarkLookupPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/clark-lookup", {
        method: "POST",
  ...
  return (
    <>
      <Script 
        id="clark-lookup-structured-data"
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900">
            Clark Forklift Serial Number Lookup
          </h1>
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            Enter a Clark serial/PIN and (optionally) a model. We'll show plate locations by family,
            infer the family from model/prefixes (TMX/ECX/GEX/GTX/EPX/S/GTS/C), and decode year only
            when a true 17-character VIN/PIN or a legacy pre-1958 pattern is detected.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-6 bg-white rounded-2xl p-6 shadow-lg border">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input 
                className="w-full rounded-xl border border-gray-300 px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                placeholder="e.g., TMX20 A123456, or 17-char VIN/PIN" 
                value={serial} 
                onChange={(e) => setSerial(e.target.value)} 
                required 
              />
              <p className="mt-2 text-xs text-slate-500">
                Tip: Clark's serial/data plate is usually in the operator compartment; the serial is also stamped on the frame.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <input 
              className="w-full rounded-xl border border-gray-300 px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
              placeholder="e.g., TMX20, ECX25, S25C, GTS25" 
              value={model} 
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="rounded-xl bg-white p-4 border border-gray-200">
                      <div className="text-sm text-slate-500 mb-1">Estimated year</div>
                      <div className="font-medium text-gray-900">
                        {data.parsed?.year ?? "—"}
                      </div>
                    </div>
                    ...
                    <ul className="space-y-3">
                      {plateTips.length ? plateTips.map((tip, i) => (
                        ...
                        <li className="text-slate-700">
                          Check the capacity/data plate; locations vary by family and series.
                        </li>
                      )}
                    </ul>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                      ...
                      <div className="text-sm text-slate-600">Fast pricing on Clark parts</div>
                    </a>
                    ...
                    >
                      ...
                      <div className="font-medium text-gray-900 group-hover:text-orange-600">Clark Parts</div>
                    ...
                    >
                      ...
                      <div className="font-medium text-gray-900 group-hover:text-yellow-600">Clark Battery Chargers</div>
