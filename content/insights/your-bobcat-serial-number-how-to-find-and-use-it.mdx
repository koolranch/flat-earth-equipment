...
| Series || Location |
| R-Series || Right upper-rear, above tailgate |
| M-Series || Right of the main frame, under cooling compartment |
| K-Series || Rear frame upright (right or left) |
| Older Models || Varies on rear upright (inside/outside) |
| Articulated || Lower frame (entry side) |
