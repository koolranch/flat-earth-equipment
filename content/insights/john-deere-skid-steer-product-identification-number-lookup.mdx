...
| Information Type || Detail || Location for Documentation |
| Product ID Number (PIN) || 17-digit code || Digital file/Equipment log |
| Engine Serial Number || Specific engine details || Maintenance notebook/App |
| Online Product Database || Manuals, Dates, etc. || Bookmark/Search History |
