...
export const RUBBER_TRACK_MODEL_LINKS: Record<string, TrackModelLink[]> = {
  ...
  caterpillar: [
    { model: '279D', slug: 'caterpillar-279d-rubber-track-450x86x56' },
  ...
  'john deere': [
    { model: '317G', slug: 'john-deere-317g-rubber-track-320x86x50' },
    { model: '331G', slug: 'john-deere-331g-rubber-track-450x86x58' },
