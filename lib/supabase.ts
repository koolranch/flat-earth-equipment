...
// - API routes only: import { supabaseService } from '@/lib/supabase/service'
...
throw new Error(
  ...
  'Use context-specific clients from @/lib/supabase/client, @/lib/supabase/server, or @/lib/supabase/service'
); 